...
так жу прошу обратить внимание  на стартап конфиг роутера, ту команду, которой я первый раз назначал линк локал ipv6address link-local адрес/64 - удалить не удается через no. Может из-за этого проблемы?


<img src="/lesson9/img/15.png" alt="Alt text"/>

Сбросил роутер, настроил заново, ПК запинговали друг друга, но коммутатор не пингуется
...
Пинг по Глобал до коммутатора появился после задания шлюза в режиме глобальной конфигурации  ipv6 route ::/0 2001:db8:acad:1::1

Но пинга по линк локал по-прежнему нет

<img src="/lesson9/img/18.png" alt="Alt text"/>
