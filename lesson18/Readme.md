...
Заблокированный порт изменился, потому что у 1 порт рут порт, а следующий по приоритету 2 порт. А на 3 свитче приоритет тот же, стоимость та же, но мак больше.
